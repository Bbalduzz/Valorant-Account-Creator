import sys
from PyQt6.QtCore import QPoint, Qt, QEventLoop, QTimer, QSize, QRect, QThread, pyqtSignal
...
from qfluentwidgets import (InfoBarIcon, InfoBar, setTheme, Theme, InfoBarPosition, SplashScreen, CardWidget, setTheme, Theme, IconWidget, BodyLabel, CaptionLabel, PushButton,
                            TransparentToolButton, FluentIcon, RoundMenu, Action, PushButton, StateToolTip, ComboBox)
from qframelesswindow import FramelessWindow, StandardTitleBar

# from src.chrome import RiotGen
# from src.firefox import RiotGen
...
class CredentialCard(CardWidget):
    ...
    def onMoreButtonClicked(self):
        ...
        menu.addAction(Action(FluentIcon.CHAT, 'Write comment', self))
        menu.addAction(Action(FluentIcon.PIN, 'Pin to taskbar', self))
